...
class AIHub(datasets.GeneratorBasedBuilder):
    ...
    BUILDER_CONFIGS = [
        ...
        AIHubConfig(
            ...
            data_sp_path={datasets.Split.TRAIN: ['Training/train_법률_data/법률문서/train_original.json'],
                          datasets.Split.VALIDATION: ['Validation/valid_법률_data/법률문서/dev_original.json']},
        ...
        AIHubConfig(
            ...
            data_sp_path={datasets.Split.TRAIN: ['Training/train_사설잡지_data/train_original.json'],
                          datasets.Split.VALIDATION: ['Validation/valid_사설잡지_data/dev_original.json']},
    ...
    DOCUMENT_SUMMARY_EDITORIAL(v1.0): manual_dir/AIHub/문서요약 텍스트/Training/train_사설잡지_data/train_original.json
                                      manual_dir/AIHub/문서요약 텍스트/Validation/valid_사설잡지_data/dev_original.json
